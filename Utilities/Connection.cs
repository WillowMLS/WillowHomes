...
namespace Utilities
{
    public class DBConnect
    {
        ...
        String SqlConnectString = "server=cis-mssql1.temple.edu;Database=fa24_3342_tuo43905;User id=tuo43905;Password=ohK9xuwei7Ei";

        // Home Connection String - used for working from home using SSH Tunneling.
        //String SqlConnectString = "server=127.0.0.1,5555;Database=fa24_3342_tuo43905;User id=tuo43905;Password=ohK9xuwei7Ei";
